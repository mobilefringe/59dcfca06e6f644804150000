...
function drop_pin(id, map){
    ...
    map.setMarks([{ xy: [coords["x"] - 20 + x_offset, coords["y"] - 55 + y_offset],
        attrs: {
            src:  '//codecloud.cdn.speedyrails.net/sites/5af3606b6e6f64457d440000/image/png/1509995814000/map_pin4.png'     // image for marker
            }
        }
    ])
    map.setViewBox(id);
    ...
    $(trigger).click(function(e) {
        ...
        $(map).smoothZoom('addLandmark', 
			...
			'<div class="item mark" data-show-at-zoom="0" data-position="'+x_coord+','+y_coord+'">\
				...
				<img src="//codecloud.cdn.speedyrails.net/sites/5af3606b6e6f64457d440000/image/png/1509993079000/map_marker_4.png" width="40px" height="59px" alt="marker" />\
				</div>\
			</div>'
			]
		);
